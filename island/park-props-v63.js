...
async function loadParkProps63Uncached({scene,renderer,sample,variant},foliageShared){
 const loader=new GLTFLoader();
 const [furniture,lowerBridge,toys,foliage,layout]=await Promise.all([
  loader.loadAsync('/67park-island/island/park-furniture-v57.glb?v=1'),loader.loadAsync('/67park-island/island/park-lower-bridge-v63.glb?v=anchor2'),loader.loadAsync('/67park-island/island/park-toys-v57.glb?v=1'),
  foliageShared,
...
export function loadParkProps63(options){
 return withIslandFoliage(options.assetSession,()=>new GLTFLoader().loadAsync('/67park-island/island/small-island-props-v45.glb?v=round1'),foliage=>loadParkProps63Uncached(options,foliage));
}
