...
export async function loadParkProps57({scene,renderer,sample,variant}){
 ...
 const [furniture,toys,foliage,layout,landingProfiles]=await Promise.all([
  loader.loadAsync('/67park-island/island/park-furniture-v57.glb?v=1'),loader.loadAsync('/67park-island/island/park-toys-v57.glb?v=1'),
  loader.loadAsync('/67park-island/island/small-island-props-v45.glb?v=round1'),
