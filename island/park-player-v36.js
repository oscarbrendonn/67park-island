...
export class IslandCharacterController extends ParkCore{
  ...
  update(dt,input){
    ...
    if(w>.001){
      ...
      // Keep the relaxed shoulders fixed. In this mirrored rig, negative X
      // puts BOTH hands behind the elbow in the torso frame. Positive X bends
      // them forward; the modest mirrored Z keeps breathing room at the sides.
      // This is a 29-degree bend, with wrists 4.3 cm FORWARD of the elbows,
      // rather than v33's 3.0 cm behind. Hands stay neutral and feet untouched.
      ...
      this.pose('ArmL',.30,0,.70,w);this.pose('ArmR',.30,0,-.70,w);
    ...
    Object.assign(this.env.data,{characterController:'six-seven-park-v36',characterAnimation:result.state,playerCharacter:this.body.userData.characterId||'goril',
      ...
      skateArms:riding?'forward-soft-elbows-v36':'authored',neckFinish:this.body.userData.neckFinish?'body-matched-v30':'original',
