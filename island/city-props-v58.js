...
import {mergeGeometries} from '/67park-island/island/utils/BufferGeometryUtils.js';
...
export async function loadCityProps58({scene,renderer,sample,variant}){
 ...
 const [buildings,bridge,layout,bridgeMeta]=await Promise.all([
  loader.loadAsync('/67park-island/island/city-buildings-v58.glb?v=1'),loader.loadAsync('/67park-island/island/city-bridge-v58.glb?v=1'),
