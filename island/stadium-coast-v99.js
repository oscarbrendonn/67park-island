...
export function createStadiumCoast99({scene,terrainRoot,renderer,sample,variant}){
 ...
 const stats={...layout99,stadium:stadiumWidth.layout,islandWidth:stadiumWidth.stats,stairs:stadiumStairs,draws,triangles,grey:reference.color.getHexString(),foliage:plants.stats,entrance:'open south portal plus west and east double doors',pitch67:'approved flat numeral geometry',football:{position:football.position.toArray(),radius:.34,interactive:false},roadsModified:false,curbsModified:false,lighthouseModified:false,marinaModified:false,ground};
